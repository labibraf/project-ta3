            ...
            <form action="{{ route('peserta.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nama_lengkap" id="nama_lengkap"
                        ...
                        value="{{ old('nama_lengkap') }}" required autofocus autocomplete="off">
                    @error('nama_lengkap')
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="nomor_identitas" id="nomor_identitas"
                        ...
                        value="{{ old('nomor_identitas') }}" required autofocus autocomplete="off">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" name="no_telepon" id="no_telepon"
                        ...
                        value="{{ old('no_telepon') }}" required autofocus autocomplete="off">
                    @error('no_telepon')
                        <small class="text-danger">
                            {{ $message }}
                        </small>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="asal_instansi" id="asal_instansi"
                        ...
                        value="{{ old('asal_instansi') }}" required autofocus autocomplete="off">
                    @error('asal_instansi')
                        <small class="text-danger">
                            {{ $message }}
                        </small>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="jurusan" id="jurusan"
                        ...
                        value="{{ old('jurusan') }}" required autofocus autocomplete="off">
                    @error('jurusan')
                        <small class="text-danger">
                            {{ $message }}
                        </small>
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="tipe_magang" id="tipe_magang"
                        ...
                        <option value="Kerja Praktik"
                            {{ old('tipe_magang') == 'Kerja Praktik' ? 'selected' : '' }}>
                            Kerja Praktik</option>
                        <option value="Magang Nasional"
                            {{ old('tipe_magang') == 'Magang Nasional' ? 'selected' : '' }}>
                            Magang Nasional</option>
                        <option value="Penelitian"
                            {{ old('tipe_magang') == 'Penelitian' ? 'selected' : '' }}>
                            Penelitian</option>
                    </select>
                    @error('tipe_magang')
                        <small class="text-danger">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tanggal_mulai_magang" id="tanggal_mulai_magang"
                        ...
                        value="{{ old('tanggal_mulai_magang') }}" required autofocus autocomplete="off">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tanggal_selesai_magang" id="tanggal_selesai_magang"
                        ...
                        value="{{ old('tanggal_selesai_magang') }}" required autofocus autocomplete="off">
